                                ...
                                {!discordLinked ? (
                                    <div className="space-y-2">
                                        <button
                                            ...
                                            className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg font-bold text-xs transition-all bg-[#5865F2] hover:bg-[#4752C4] text-white shadow-lg shadow-[#5865F2]/25 cursor-pointer active:scale-[0.98]"
                                        >
                                        ...
                                        <p className="text-[10px] text-foreground/35 text-center">Required for room IDs & match updates</p>
                                    </div>
                                ) : (
