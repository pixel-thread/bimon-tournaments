                        ...
                        {whatsappGroupLink && (
                            <div className="px-4 pb-2">
                                <a
                                    ...
                                    className="flex items-center justify-center gap-2 w-full rounded-lg bg-emerald-500/10 border border-emerald-500/20 px-3 py-2 text-sm font-semibold text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/20 transition-colors"
                                >
