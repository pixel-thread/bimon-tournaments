                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {step === "done" && (
                            <motion.div
                                ...
                                className="space-y-4"
                            >
                                {/* WhatsApp join — must click first before copy/invite */}
                                {whatsappGroupLink && (
                                    <a
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0 text-left">
                                            <p className="text-sm font-semibold text-emerald-700 dark:text-emerald-300">
                                                {whatsappJoined ? "Joined ✅" : "Join WhatsApp Group"}
                                            </p>
                                            <p className="text-[11px] text-emerald-600/60 dark:text-emerald-400/60">
                                                Room ID, password, slot number & more
                                            </p>
                                        </div>
                                    </a>
                                )}

                                {/* Gate: show copy link & invite only after WhatsApp joined (or if no link) */}
                                {(!whatsappGroupLink || whatsappJoined) && (
                                    <motion.div
                                        initial={{ opacity: 0, y: 8 }}
                                        animate={{ opacity: 1, y: 0 }}
                                            ...
                                            >
                                                <div className="flex-1 min-w-0 text-left">
                                                    ...
                                                    <p className="text-[11px] text-blue-600/60 dark:text-blue-400/60">
                                                        Share with your teammates to quickly join your team
                                                    </p>
                                                </div>
                                ...
                                {/* Hint when WhatsApp not yet joined */}
                                {whatsappGroupLink && !whatsappJoined && (
