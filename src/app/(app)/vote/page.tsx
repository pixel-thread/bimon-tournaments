        ...
        <div className="mx-auto max-w-lg px-4 py-6 sm:px-6">
            ...
            {tab === "casual" && casualRoomIdLink && !casualWADismissed && (
                <div className="relative mb-4">
                    ...
                    <button
                        type="button"
                        onClick={(e) => { e.stopPropagation(); setCasualConfirmOpen(true); }}
            ...
            {/* ── Casual WA dismiss confirmation modal ── */}
            {casualConfirmOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    <div className="absolute inset-0 bg-black/50 backdrop-blur-sm" onClick={() => { setCasualConfirmOpen(false); setCasualConfirmText(""); }} />
                    <div className="relative bg-background border border-divider rounded-2xl shadow-2xl mx-4 max-w-xs w-full p-5 space-y-3">
                        ...
                        <div className="flex gap-2">
                            <button
                                type="button"
                                onClick={() => { setCasualConfirmOpen(false); setCasualConfirmText(""); }}
