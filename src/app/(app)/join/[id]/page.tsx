...
export default function JoinPage() {
    ...
    // Check Discord link status for ranked tournaments
    useEffect(() => {
        if (!data?.allowSquads) return;
    ...
    const isRankedTournament = data.allowSquads;
    const canSubmit = ((useClan && hasClan) || teamName.trim().length > 0) && !isFull && step === "form" && (!isRankedTournament || discordLinked);
                    ...
                    >
                        ...
                        {!isFull && (
                            <div className="space-y-3">
                                ...
                                {/* Discord requirement — ranked tournaments */}
                                {isRankedTournament && !discordLinked && (
