...
import { Button, Spinner, Avatar, Modal, ModalContent, ModalBody } from "@heroui/react";
...
export default function InvitePage() {
    ...
    const handleAccept = useCallback(async () => {
        ...
        try {
            ...
            setJoined(true);
            // If there's a WhatsApp group, show mandatory modal before redirecting
                    ...
                    <ModalBody className="py-8 text-center space-y-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-foreground/50">
                                Join to receive <strong>room ID, password, points table, slot number</strong> & more for <strong>{data.tournamentName}</strong>
                            </p>
                        </div>
                        <a
