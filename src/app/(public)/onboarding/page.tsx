...
export default function OnboardingPage() {
    ...
    /* ── Discord linking screen after onboarding (disabled — kept for future use) ──
    if (showDiscord) {
        return (
                ...
                >
                    <div className="rounded-2xl border border-divider bg-background/80 backdrop-blur-xl shadow-xl overflow-hidden">
                        ...
                        <div className="px-6 pb-6 space-y-4 pt-4">
                            <button
                                type="button"
                                onClick={() => { openDiscordModal(`/api/discord/authorize?returnTo=onboarding`); }}
                                className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold text-base bg-[#5865F2] text-white"
                            >
                                Link with Discord
                            </button>
                        </div>
